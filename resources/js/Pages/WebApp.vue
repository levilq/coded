<template>
    <div class="bg-cbrown text-white">
        <div class="flex justify-center bg-black py-4">
            <img class="h-12" src="images/coded-logo.svg">
        </div>
        <div class="pt-10">
            <div class="flex md:px-32 grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="pt-8 pb-9 lg:ml-48 justify-center flex">
                    <img class="h-96" src="/images/banner15.png">
                </div>
            </div>
        </div>
        <div class="flex justify-center">
            <div class="flex grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <div class="flex-shrink-0 m-6 relative overflow-hidden bg-amber-400 rounded-lg max-w-xs shadow-lg flex">
                    <div class="relative text-white px-6 pb-6 mt-6">
                        <span class="block opacity-75 -mb-1">Completed Project</span>
                        <div class="flex justify-between">
                            <span class="block font-semibold text-4xl pt-4">19</span>
                        </div>
                    </div>
                    ...
                    <div class="relative pt-10 px-10 flex items-center justify-center">
                        ...
                        <img class="relative w-40" src="/images/i_complete.png" alt="">
                    </div>

                </div>
                <div class="flex-shrink-0 m-6 relative overflow-hidden bg-blue-500 rounded-lg max-w-xs shadow-lg flex">
                    <div class="relative text-white px-6 pb-6 mt-6">
                        <span class="block opacity-75 -mb-1">Working Hours</span>
                        <div class="flex justify-between">
                            <span class="block font-semibold text-4xl pt-4">4390</span>
                        </div>
                    </div>
                    <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none" style="transform: scale(1.5); opacity: 0.1;">
                        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
                    ...
                    <div class="relative pt-10 px-10 flex items-center justify-center">
                        <div class="block absolute w-48 h-48 bottom-0 left-0 -mb-24 ml-3" style="background: radial-gradient(black, transparent 60%); transform: rotate3d(0, 0, 1, 20deg) scale3d(1, 0.6, 1); opacity: 0.2;"></div>
                        <img class="relative w-40" src="/images/i_working_hours.png" alt="">
                    </div>

                </div>
                <div class="flex-shrink-0 m-6 relative overflow-hidden bg-rose-400 rounded-lg max-w-xs shadow-lg flex">
                    <div class="relative text-white px-6 pb-6 mt-6">
                        <span class="block opacity-75 -mb-1">Happy Clients</span>
                        <div class="flex justify-between">
                            <span class="block font-semibold text-4xl pt-4">40</span>
                        </div>
                    </div>
                    <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none" style="transform: scale(1.5); opacity: 0.1;">
                        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
        ...
        <div class="text-white px-12 pb-16 pt-10">
        ...
        <div class="text-white px-14 pb-16 pt-10">
...
<!--            </div>-->
        ...
        <div class="text-white px-8 pb-16 pt-10">
            <div class="mx-auto">
...
import CardNew from "@/Pages/Components/CardNew.vue";
import OurWork from "@/Pages/Components/OurWork.vue";
</script>
